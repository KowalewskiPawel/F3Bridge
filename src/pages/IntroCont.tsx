    ...
    <HomeSectionContainer name="HomePage2">
      <div className="ml-64 mr-64">
        ...
        <p className="flex pb-8 align-middle text-md font-medium text-white/90 ">
          F3Bridge is a decentralised application that acts both as a bridge and social media app.
          First of all it allows web2 apps users to transition smoothly to the web3 environment, and
          use their web2 data. Since the content is completely decentralised in our app, there is
          almost* no way of banning us from the posting any kind of content. <br className="mt-2" />
          Naturally, there are still some edge-cases when it would be better to remove certain
          content. We can ban the given user or the content, in the way of democratic/ DAO voting.
          user. <br className="mt-2" />
          Since Web3 is heavily connected to the idea of barter and money, in our app we also give
          the option to support our favourite creators by creating money streams. Additionally, this
          solutions gives the possibility to stop the money stream if the content creator is not
      ...
      <div className="flex w-full justify-center">
        <div className="flex items-center bg-black justify-center w-[200px] m-30 ">
          <div className="relative group w-full lg:mt-40">
            ...
            >
              <span className="text-gray-100 text-xl font-extrabold">Enter App</span>
            </button>
          </div>
        </div>
      </div>
      ...
      <div className="flex m-10 lg:space-x-80 absolute bottom-0 flex-row space-x-10 justify-center">
        ...
        <img
          ...
          height="150"
        />
        <img src="https://cryptologos.cc/logos/polygon-matic-logo.png" width="150" />
        <img
