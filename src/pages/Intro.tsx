...
import F3Logo from "../assets/f3bridge.png";
  ...
  return (
    <HomeSectionContainer name="Home">
      <div className="flex justify-center mt-10">
        <img src={F3Logo} alt="logo" width={100} height={100} />
      </div>
      <LandingSectionContainer>
        <Logo>F3BRIDGE</Logo>
        <p className="flex pb-8 justify-center text-lg text-white/90">
          F3Bridge is both a bridge to move your social media accounts from Web2 to Web3, and a
          social media platform at the same time.
        </p>
